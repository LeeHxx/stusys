...
<head>
	...
	$(".btn").click(function(){
		...
		var mm=$("#mm").val();
			if (confirm("确定修改吗？")){
				$.post("edit_gly.php",{id:id,zh:zh,mm:mm},function(data){
					if($.trim(data)=='yes'){
						alert('修改成功！');
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<form class="form-horizontal" name="form1" action="" method="post">
					...
					<div class="form-group">
						<div class="col-sm-4">账号
							<input type="text" class="form-control" name="zh" id="zh" value="<?php echo $sql_arr['zh']?>"
							>
						</div>
					...
					<div class="form-group">
						<div class="col-sm-4">密码
							<input type="text" class="form-control" name="mm" id="mm" value="<?php echo $sql_arr['mm']?>"
							>
						</div>
						</div>
						<div class="form-group">
